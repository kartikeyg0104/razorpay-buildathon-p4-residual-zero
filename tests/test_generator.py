...
def test_forbidden_classes_absent():
    """Class ids 24, 25, 26 appear nowhere in the enum or the corpus."""
    assert not hasattr(CorruptionClass, "FEE_RATE_DRIFT")
    assert 24 not in set(CorruptionClass)
